...
export const Component = () => {
  ...
  useEffect(() => {
    const initThree = () => {
      ...
      refs.scene.fog = new THREE.FogExp2(0x050302, 0.00025);
    ...
    const createStarField = () => {
      ...
      for (let i = 0; i < 3; i++) {
        ...
        for (let j = 0; j < starCount; j++) {
          ...
          // Warm brand color variation
          const color = new THREE.Color();
          const colorChoice = Math.random();
          if (colorChoice < 0.7) {
            color.setHSL(0.07, 0.25, 0.85 + Math.random() * 0.15);
          } else if (colorChoice < 0.9) {
            color.setHSL(0.08, 0.7, 0.75);
          } else {
            color.setHSL(0.02, 0.7, 0.68);
          }
    ...
    const createNebula = () => {
      ...
      const material = new THREE.ShaderMaterial({
        uniforms: {
          time: { value: 0 },
          color1: { value: new THREE.Color(0xf25c54) },
          color2: { value: new THREE.Color(0xf7941d) },
          opacity: { value: 0.32 },
        },
        vertexShader: `
          varying vec2 vUv;
    ...
    const createMountains = () => {
      ...
      const layers = [
        { distance: -50, height: 60, color: 0x2b1a17, opacity: 1 },
        { distance: -100, height: 80, color: 0x3a2018, opacity: 0.8 },
        { distance: -150, height: 100, color: 0x4a2419, opacity: 0.6 },
        { distance: -200, height: 120, color: 0x5a2a1c, opacity: 0.4 },
      ];
      ...
      const material = new THREE.ShaderMaterial({
        ...
        fragmentShader: `
          ...
          void main() {
            ...
            vec3 atmosphere = vec3(1.0, 0.45, 0.2) * intensity;
  ...
  const subtitles: Record<number, { line1: string; line2: string }> = {
    0: {
      line1: "Premium meat distribution,",
      line2: "quality you can taste, service you can trust",
    },
    1: {
      line1: "Beef, lamb, poultry and more —",
      line2: "sourced and delivered with the utmost care",
    },
    2: {
      line1: "From our cold chain to your kitchen,",
      line2: "freshness guaranteed with every order",
    },
  };
  ...
  return (
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div ref={menuRef} className="side-menu" style={{ visibility: "hidden" }}>
        ...
        <div className="vertical-text">MEC</div>
      </div>

      {/* Main content */}
      <div className="hero-content cosmos-content">
        <h1 className="hero-title">{titles[0]}</h1>
        ...
        {[...Array(2)].map((_, i) => {
          return (
            <section key={i} className="content-section">
              <h1 ref={i === 1 ? titleRef : undefined} className="hero-title">
                {titles[i + 1] || "DEFAULT"}
              </h1>

              <div
                ref={i === 1 ? subtitleRef : undefined}
